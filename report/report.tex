...
With LibSVM we scored 0.56619 on Kaggle. Using LibLinear we only reached 0.52422. The training data is read in 5 minutes, after which calculation of all the features took 20 minutes. The size of the featurematrix results in 124 MiB.
